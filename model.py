...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=HIDDEN_LAYER_1, fc2_units=HIDDEN_LAYER_2):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=HIDDEN_LAYER_1, fc2_units=HIDDEN_LAYER_2):
        """Initialize parameters and build model.
